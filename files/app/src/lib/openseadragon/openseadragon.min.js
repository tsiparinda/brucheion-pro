        ...
        for (t in e) {
          ...
          if (s !== (n = e[t]))
            if (
              l &&
              n &&
              (OpenSeadragon.isPlainObject(n) || (o = OpenSeadragon.isArray(n)))
            ) {
              if (o) {
                o = !1
  ...
  function S(e) {
    ...
    if (!t.preventDefaultAction && this.viewport) {
      ...
      if (i.flickEnabled && e.speed >= i.flickMinSpeed) {
        var n = 0
        this.panHorizontal &&
          (n = i.flickMomentum * e.speed * Math.cos(e.direction))
        t = 0
        this.panVertical &&
          (t = i.flickMomentum * e.speed * Math.sin(e.direction))
  ...
  h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
    ...
    getTileUrl: function (e, t, i) {
      ...
      var o,
        ...
        c = Math.ceil(this.width * h),
        u = Math.ceil(this.height * h)
    ...
    start: function () {
      ...
      if (this.loadWithAjax) {
        this.request = t.makeAjaxRequest({
          ...
          error: function (e) {
            o.errorMsg =
              'Image load aborted - XHR error: Ajax returned ' + e.status
            o.finish(!1)
          },
        })
        this.abort = function () {
...
!(function (d) {
  ...
  d.Tile.prototype = {
    ...
    drawCanvas: function (e, t, i, n, o) {
      var r,
        s = this.position.times(d.pixelDensityRatio),
        a = this.size.times(d.pixelDensityRatio)
      if (this.context2D || this.cacheImageRecord) {
        ...
        if (this.loaded && r) {
          ...
          t({ context: e, tile: this, rendered: r })
          var l, h
...
!(function (a) {
  a.Viewport = function (e) {
    ...
    if (
      (e =
        t.length && t[0] instanceof a.Point
  ...
  a.Viewport.prototype = {
    ...
    setMargins: function (e) {
      ...
      this._margins = a.extend({ left: 0, top: 0, right: 0, bottom: 0 }, e)
      this._updateContainerInnerSize()
    ...
    _applyBoundaryConstraints: function (e) {
      ...
      if (!this.wrapHorizontal) {
        ...
        n = n - e.x - t
        t > this._contentBoundsNoRotate.width
          ? (e.x += (i + n) / 2)
          : n < 0
          ? (e.x += n)
          : 0 < i && (e.x += i)
      ...
      if (!this.wrapVertical) {
        ...
        i = i - e.y - t
        t > this._contentBoundsNoRotate.height
          ? (e.y += (n + i) / 2)
          : i < 0
          ? (e.y += i)
          : 0 < n && (e.y += n)
    ...
    applyConstraints: function (e) {
      ...
      ;(t.x === i.x && t.y === i.y && !e) ||
        this.fitBounds(i.rotate(-this.getRotation()), e)
      return this
    },
    ...
    _fitBounds: function (e, t) {
      ...
      r = (e = e.rotate(-this.getRotation()))
        .getTopLeft()
        .times(o)
        .minus(s.getTopLeft().times(r))
        .divide(o - r)
    ...
    zoomTo: function (e, t, i) {
      var n = this
      this.zoomPoint =
        t instanceof a.Point && !isNaN(t.x) && !isNaN(t.y) ? t : null
      i
      ...
      if (0 !== this.opacity && (0 !== e.length || this.placeholderFillStyle)) {
        ...
        t &&
          (i =
            ...
            (!this._isBottomItem() && t._hasTransparencyChannel()))
        var n
        var o
        ...
        if (this._croppingPolygons) {
          ...
          try {
            var l = this._croppingPolygons.map(function (e) {
              return e.map(function (e) {
                e = this.imageToViewportCoordinates(e.x, e.y, !0).rotate(
                  -this.getRotation(!0),
                  this._getRotationPoint(!0)
                )
        ...
        var c = !1
        h === y.SUBPIXEL_ROUNDING_OCCURRENCES.ALWAYS
          ? (c = !0)
          : h === y.SUBPIXEL_ROUNDING_OCCURRENCES.ONLY_AT_REST &&
            (c = !(this.viewer && this.viewer.isAnimating()))
